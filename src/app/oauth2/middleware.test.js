...
describe("oauth middleware", () => {
  ...
  describe("decryptJWTAuthorizeRequest and store oauth params in session", () => {
    ...
    beforeEach(() => {
      ...
      const resolvedPromise = new Promise((resolve) =>
        resolve({ data: { authParams, sessionId } })
      );
  ...
  describe("redirectToDrivingLicenceDetailsPage", () => {
  ...
  describe("redirectToCallback", () => {
      ...
      req = {
        session: {
          JWTData: {
            authParams: {
              redirect_uri:
                "https%3A%2F%2Fclient%2Eexample%2Ecom%2Fcb?id=DrivingLicenceIssuer",
            },
          },
        },
      };
    ...
    it("should successfully redirect with redirect_url stored in session", async function () {
      req.session["hmpo-wizard-cri-driving-licence-front"] = {
        redirect_url:
          "https://client.example.com/cb?id=DrivingLicence&code=1234",
      };
