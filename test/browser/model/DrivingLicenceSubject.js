function DrivingLicenceSubject(licenceNumber,birthDay,birthMonth,birthYear,licenceIssueDay,licenceIssueMonth,licenceIssueYear,issueNumber,consentDVLACheckbox,middleNames,lastName,firstName,licenceValidToDay,licenceValidToMonth,licenceValidToYear,postcode) {
...
DrivingLicenceSubject.prototype.setLicenceIssueDay = function(licenceIssueDay) {
...
DrivingLicenceSubject.prototype.setLicenceIssueMonth = function(licenceIssueMonth) {
...
DrivingLicenceSubject.prototype.setLicenceIssueYear = function(licenceIssueYear) {
...
DrivingLicenceSubject.prototype.setConsentDVLACheckbox = function(consentDVLACheckbox) {
...
DrivingLicenceSubject.prototype.setLicenceValidToDay = function(licenceValidToDay) {
...
DrivingLicenceSubject.prototype.setLicenceValidToMonth = function(licenceValidToMonth) {
...
DrivingLicenceSubject.prototype.setLicenceValidToYear = function(licenceValidToYear) {
...
DrivingLicenceSubject.prototype.equals = function(otherDrivingLicenceSubject) {
    return otherDrivingLicenceSubject.getLicenceNumber() == this.getLicenceNumber()
        ...
        && otherDrivingLicenceSubject.getLicenceIssueDay() == this.getLicenceIssueDay()
        && otherDrivingLicenceSubject.getLicenceIssueMonth() == this.getLicenceIssueMonth()
        && otherDrivingLicenceSubject.getLicenceIssueYear() == this.getLicenceIssueYear()
        && otherDrivingLicenceSubject.getIssueNumber() == this.getIssueNumber()
        && otherDrivingLicenceSubject.getConsentDVLACheckbox() == this.getConsentDVLACheckbox()
        ...
        && otherDrivingLicenceSubject.getLicenceValidToDay() == this.getLicenceValidToDay()
        && otherDrivingLicenceSubject.getLicenceValidToMonth() == this.getLicenceValidToMonth()
        && otherDrivingLicenceSubject.getLicenceValidToYear() == this.getLicenceValidToYear()
