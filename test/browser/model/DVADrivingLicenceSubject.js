function DVADrivingLicenceSubject(licenceNumber,birthDay,birthMonth,birthYear,licenceIssueDay,licenceIssueMonth,licenceIssueYear,consentDVACheckbox,middleNames,lastName,firstName,licenceValidToDay,licenceValidToMonth,licenceValidToYear,postcode) {
...
DVADrivingLicenceSubject.prototype.setLicenceIssueDay = function(licenceIssueDay) {
...
DVADrivingLicenceSubject.prototype.setLicenceIssueMonth = function(licenceIssueMonth) {
...
DVADrivingLicenceSubject.prototype.setLicenceIssueYear = function(licenceIssueYear) {
...
DVADrivingLicenceSubject.prototype.setConsentDVACheckbox = function(consentDVACheckbox) {
...
DVADrivingLicenceSubject.prototype.setLicenceValidToDay = function(licenceValidToDay) {
...
DVADrivingLicenceSubject.prototype.setLicenceValidToMonth = function(licenceValidToMonth) {
...
DVADrivingLicenceSubject.prototype.setLicenceValidToYear = function(licenceValidToYear) {
...
DVADrivingLicenceSubject.prototype.equals = function(otherDVADrivingLicenceSubject) {
    return otherDVADrivingLicenceSubject.getLicenceNumber() == this.getLicenceNumber()
        ...
        && otherDVADrivingLicenceSubject.getLicenceIssueDay() == this.getLicenceIssueDay()
        && otherDVADrivingLicenceSubject.getLicenceIssueMonth() == this.getLicenceIssueMonth()
        && otherDVADrivingLicenceSubject.getLicenceIssueYear() == this.getLicenceIssueYear()
        && otherDVADrivingLicenceSubject.getConsentDVACheckbox() == this.getConsentDVACheckbox()
        ...
        && otherDVADrivingLicenceSubject.getLicenceValidToDay() == this.getLicenceValidToDay()
        && otherDVADrivingLicenceSubject.getLicenceValidToMonth() == this.getLicenceValidToMonth()
        && otherDVADrivingLicenceSubject.getLicenceValidToYear() == this.getLicenceValidToYear()
